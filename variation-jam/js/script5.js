...
function setup() {
  ...
  submitButton.position(
    answerBox.x + answerBox.width / 2 - submitButton.width / 2,
    answerBox.y + 70
  );
...
function draw() {
  ...
  if (currentState === "wish") {
    ...
    text(
      "We have heard you. We are here with you. We listen to your wish.",
      windowWidth / 2,
      windowHeight / 2 - 50
    );
    textSize(30);
    text(
      "Stay here with us. Forever and Ever.",
      windowWidth / 2,
      windowHeight / 2 + 50
    );
    textSize(10);
...
function mousePressed() {
  ...
  if (
    currentState === "wish" &&
    mouseX > answerBox.x &&
    mouseX < answerBox.x + answerBox.width &&
    mouseY > answerBox.y &&
    mouseY < answerBox.y + answerBox.height
  ) {
    answerBox.value("");
  }
}
