...
const trafficLight = {
    ...
    delay: 2000 // How long between lights in milliseconds
};
...
function setup() {
    ...
    //setTimeout - function that you want when the time is up
    //setInterval - function that you want to happen repeatedly
