...
-   This time, I was really struggling to start the code itself. I wasn’t sure what to do to twist the code, not to mention that I was feeling extra nervous, so I put it off until the last minute. When the deadline was near, I realized that I had to start it, otherwise I would never finish this assignment. Thankfully, my superpower (getting things done very last minute) kicked in, and Sabine was gracious enough to give an extension, so I was able to complete my code. Before jumping into someone else’s work, I wanted to talk about how this experience of coding an actual game helped me understand the class materials better. One of the main reasons why I didn’t start the code (along with the health issues) was that I didn’t understand the class materials well enough, and I was nervous that I would not be able to make any progress in my project. However, the actual coding experience, despite all the stress and panic, helped me understand the class material way better than the assignments, and I believe that I have a better understanding of the class material since I’ve completed my project. I also had a sense of achievement upon completing the project. I appreciate this opportunity to learn better, and I now feel more prepared for the variation jam project. 
